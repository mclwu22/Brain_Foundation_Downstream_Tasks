...
import os
import torch
from trainers.dinov3_volume2d_trainer import  dinov3_volume2d_trainer_BraTS_modality

class slice_student_config:
    def __init__(self):

        # ---- Dataset ----
        self.data_root = "/home/exx/Desktop/Med_DINOv3/Datasets/Finetune_classification/Modality/BraTS_2023/"
        self.train_csv = "train.csv"
        self.val_csv = "val.csv"
        self.train_dataset = "BraTS_2023_Modality"
        self.model = "slice_student"
        self.network = "slice_student_3d"
        self.note = f"slice_student_{self.train_dataset}"
        self.attr = 'class'
        # ---- Model ----
        self.network = "slice_student"  # ★ must match networks_dict
        self.n_slices = 128              # how many slices to sample
        self.lora_rank = 8              # LoRA rank
        self.ckpt_path = "/home/exx/Desktop/Med_DINOv3/Models/Meddinov3/high_res/57999/model.pth"  # your pretrained student
...
if __name__ == "__main__":
    ...
    Trainer = dinov3_volume2d_trainer_BraTS_modality(config)
    Trainer.train()
