...
from trainers.dinov3_stage2_volume2d_trainer import  dinov3_stage2_volume2d_trainer_BraTS_modality
...
if __name__ == "__main__":
    ...
    Trainer = dinov3_stage2_volume2d_trainer_BraTS_modality(config)
    Trainer.train()
