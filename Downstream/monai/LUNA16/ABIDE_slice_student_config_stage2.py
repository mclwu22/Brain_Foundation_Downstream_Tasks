...
import os
import torch
from trainers.dinov3_stage2_volume2d_trainer import dinov3_stage2_volume2d_trainer,dinov3_stage2_volume2d_trainer_ABIDE_attn_pooling,dinov3_stage2_volume2d_trainer_ABIDE_mean_pooling,dinov3_stage2_volume2d_trainer_ABIDE_s1and2mean_pooling

class slice_student_config:
    def __init__(self):

        # ---- Dataset ----
        self.data_root = "/home/exx/Desktop/Med_DINOv3/Datasets/Finetune_classification/ABIDE/ABIDE_Classification/"
        self.train_csv = "train.csv"
        self.val_csv = "val.csv"
        self.train_dataset = "ABIDE"
        self.model = "slice_student"
        self.network = "slice_student_3d"
        self.note = "slice_student_ABIDE_stage1concate2_mean"
        self.attr = 'class'
        # ---- Model ----
...
if __name__ == "__main__":
    ...
    # Trainer = dinov3_stage2_volume2d_trainer_ABIDE_attn_pooling(config)
    Trainer = dinov3_stage2_volume2d_trainer_ABIDE_s1and2mean_pooling(config)
    Trainer.train()
