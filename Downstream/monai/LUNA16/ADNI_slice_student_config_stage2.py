...
import os
import torch
from trainers.dinov3_stage2_volume2d_trainer import  dinov3_stage2_volume2d_trainer_ADNI

class slice_student_config:
    def __init__(self):

        # ---- Dataset ----
        self.data_root = "/home/exx/Desktop/Med_DINOv3/Datasets/Finetune_classification/ADNI/"
        self.train_csv = "train.csv"
        self.val_csv = "val.csv"
        self.train_dataset = "ADNI"
...
if __name__ == "__main__":
    ...
    Trainer = dinov3_stage2_volume2d_trainer_ADNI(config)
    Trainer.train()
