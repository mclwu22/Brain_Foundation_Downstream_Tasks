...
import os
import torch
from trainers.dinov3_volume2d_trainer import dinov3_volume2d_trainer
...
class slice_student_config:
    def __init__(self):
        ...
        self.num_workers = 4
        self.patience = 10
        self.frozen = False  # freeze student backbone
        # ---- Logging ----
        self.verbose = 1
